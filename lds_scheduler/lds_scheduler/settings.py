"""
Django settings for lds_scheduler project.
...
SECRET_KEY = 'django-insecure-7_0i=pz*+#&@2qppp8f3^$cthdjguu(j5j#9wr#8sukp%eeb(('
...
WSGI_APPLICATION = 'lds_scheduler.wsgi.application'
